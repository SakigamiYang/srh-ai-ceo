INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (138, 'https://news.sap.com/2025/06/sap-nvidia-deliver-local-business-ai/', 'Harnessing the Power of SAP and NVIDIA to Deliver SAP Business AI Locally', 'Philipp Herzig', '2025-06-11', 8, e'In an era where artificial intelligence has transitioned from a disruptive force to an operational necessity, global enterprises face new challenges and opportunities. The adoption of AI is no longer limited to experimental use cases or niche areas—it is the backbone of business transformation.
...
Explore the opportunities ahead.', '2026-06-16 13:41:09.000866', '2026-06-16 13:41:09.000866');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (139, 'https://news.sap.com/2025/06/sap-business-ai-business-value-innovation-partnerships/', 'SAP Business AI Delivering Unparalleled Business Value Through Innovation and Partnerships', 'Philipp Herzig', '2025-06-03', 8, e'AI is fast-moving, but so is our commitment to innovation. SAP has a long history of embedding AI capabilities across its portfolio.
...
Philipp Herzig is CTO and chief AI officer and a member of the Extended Board of SAP SE.', '2026-06-16 13:41:09.000866', '2026-06-16 13:41:09.000866');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (140, 'https://news.sap.com/2025/05/sap-btp-innovations-powerful-ai-capabilities-developers-business-users-sap-business-suite/', 'SAP BTP Innovations Deliver Powerful AI Capabilities to Developers and Business Users Across SAP Business Suite', 'Michael Ameling', '2025-05-22', 8, e'Businesses today are navigating an era of explosive digital transformation, rising customer expectations, and the need for constant innovation. Meanwhile, many are contending with legacy systems that require cloud transformations to stay competitive.
...
We also announced a new set of integration adapters – including IBM MQ, Google Cloud Storage, Salesforce PubSub, Anaplan, Snowflake, and more – as well as a new SAP Integration Suite user experience. This makes SAP Integration Suite the solution to modernize the integration landscape between SAP and non-SAP systems with a fast return of investment. Lea r n more about SAP Integration Suite here .
...
Michael Ameling is chief product officer of SAP BTP and a member of the Extended Board of SAP SE.', '2026-06-16 13:41:09.000866', '2026-06-16 13:41:09.000866');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (141, 'https://news.sap.com/2025/05/simplify-success-services-support-engagement-model/', 'Simplifying Success: Unveiling SAP’s Upcoming Services and Support Engagement Model', 'Thomas Saueressig', '2025-05-21', 9, e'When we created the Customer Services & Delivery Board area just over a year ago, there was a clear intention to simplify engagement with customers to drive the most value out of our cloud innovations.
...
Thomas Saueressig is a member of the Executive Board of SAP SE.', '2026-06-16 13:41:16.496785', '2026-06-16 13:41:16.496785');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (142, 'https://news.sap.com/2025/05/unleashing-business-transformation-customer-specific-ai/', 'Unleashing Business Transformation with Customer-Specific AI', 'Thomas Saueressig', '2025-05-08', 9, e'Artificial intelligence ( AI ) has become the new catalyst of enterprise innovation. Yet, as AI becomes more embedded in core business processes, one thing is becoming clear: generic, out-of-the-box solutions alone cannot meet the complex, evolving demands of modern enterprises.
...
Thomas Saueressig is a member of the Executive Board of SAP SE, Customer Services & Delivery. Sindhu Gangadharan is head of Customer Innovation Services at SAP and managing director of SAP Labs India.', '2026-06-16 13:41:16.496785', '2026-06-16 13:41:16.496785');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (143, 'https://news.sap.com/2025/04/sap-business-ai-release-highlights-q1-2025/', 'SAP Business AI: Release Highlights Q1 2025', 'Philipp Herzig', '2025-04-07', 9, e'When we said 2024 was only the beginning , we meant it. This year will be the most ambitious year for SAP Business AI yet, with a target of 400 embedded AI use cases across our cloud portfolio.
...
SAP BTP, ABAP environment SAP S/4HANA Cloud Public Edition Joule for developers, ABAP AI capabilities General availability
...
SAP Signavio Process Manager AI-assisted process modeler, text to process General availability
...
SAP Signavio Process Intelligence AI-assisted process analyzer, text to widget Beta release
...
SAP LeanIX solutions AI-assisted inventory builder General availability
...
SAP LeanIX solutions Joule Early Adopter Care
...
SAP Central Business Configuration AI-assisted scoping and configuration services General availability
...
SAP S/4HANA Cloud Public Edition AI-assisted explanations of fixed asset deprecation keys, AI-assisted easy filter, AI-assisted smart summarization, and AI-assisted financial business insights General availability
...
SAP S/4HANA Cloud Public Edition AI-assisted easy enterprise search, AI-assisted smart personalization of My Home, AI-assisted situation handling, and AI-assisted error explanation Beta release
...
AI-assisted journal upload General availability
...
AI-assisted in-house service initiation General availability
...
AI-assisted generation of trade classification proposals General availability
...
AI-assisted labor demand planning General availability
...
SAP S/4HANA Cloud Private Edition Dispute resolution agent Beta release
...
Concur Expense AI-assisted chart of accounts upload General availability
...
Concur Expense AI-assisted policy assistance Early Adopter Care
...
SAP Ariba Category Management AI-assisted category strategy recommendation General availability
...
SAP Ariba solutions Joule SAP Early Adopter Care
...
SAP Integrated Product Development AI-assisted digitalization of legacy drawings Beta release
...
SAP Green Token AI-assisted declaration image analysis Beta release
...
SAP Field Service Management Joule SAP Early Adopter Care
...
SAP Sales Cloud Version 2 and SAP Service Cloud Version 2 AI-assisted duplicate detection General availability
...
SAP Sales Cloud Version 2 Joule SAP Early Adopter Care
...
SAP CX AI Toolkit AI-assisted CX agents General availability
...
SAP CX AI Toolkit AI-assisted shopping assistant SAP Early Adopter Care
...
SAP Emarsys Customer Engagement AI-assisted report builder Beta release
...
SAP SuccessFactors Incentive Management Joule SAP Early Adopter Care
...
SAP Datasphere AI-assisted content generation for catalog General availability
...
SAP Datasphere AI-assisted search General availability
...
SAP BTP cockpit Joule General availability
...
SAP HANA Cloud AI-assisted database administration General availability
...
Generative AI hub in SAP AI Core and SAP AI Launchpad Product enhancements General availability
...
Document Information Extraction, premium edition Product enhancements General availability
...
SAP Build Process Automation Generative AI capabilities General availability
...
SAP Build Code Product enhancements General availability
...
SAP HANA Cloud Knowledge graph engine General availability
...
“The latest AI features across SAP Build solutions provide developers with a powerful tool kit to build and extend business applications across both SAP and non-SAP systems.”
...
“In utilizing generative AI, SAP Build Code offers our joint clients easier integration capabilities and a streamlined developer experience for cloud application development, boosting overall productivity and driving tangible value.”
...
Don’t wait to transform your development experience! You can take advantage of our Joule for developer capabilities today at no charge for a limited time.

We can’t wait to see how developers leverage the new Joule capabilities in SAP Build solutions.

Happy coding!

Michael Ameling is general manager and chief product officer for SAP BTP and a member of the SAP SE Extended Board.', '2026-06-16 13:41:22.455677', '2026-06-16 13:41:22.455677');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (146, 'https://news.sap.com/2025/01/transforming-customer-support-ai/', 'Transforming Customer Support With Artificial Intelligence', 'Stefan Steinle', '2025-01-31', 10, e'Customer support is one of the cornerstones of a successful business, yet it remains one of the most complex and demanding areas of the knowledge economy. It requires synthesizing vast amounts of information — including customer business needs, industry specifics, technology, and governance — into actionable insights.
...
Thomas Saueressig is a member of the Executive Board of SAP SE leading Customer Services & Delivery. Stefan Steinle is executive vice president and head of Customer Support & Cloud Lifecycle Management at SAP.', '2026-06-16 13:41:22.455677', '2026-06-16 13:41:22.455677');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (147, 'https://news.sap.com/2025/01/overcome-fragmentation-optimize-ai-benefit-of-all/', 'Why We Must Overcome Fragmentation to Optimize AI for the Benefit of All', 'Christian Klein', '2025-01-17', 11, e'A topic that has come up many times at the World Economic Forum Annual Meeting in Davos over recent years is the increasing fragmentation of our world — within societies and between nations. But, amid this division and disagreement, there is one hope that many still share: the belief that artificial intelligence (AI) will lead to significant progress across the globe.
...
This piece originally appeared on the World Economic Forum website .', '2026-06-16 13:41:29.430802', '2026-06-16 13:41:29.430802');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (148, 'https://news.sap.com/2025/01/people-perspective-preparing-intelligent-age/', 'People, Organizations, Technology: Preparing for the Intelligent Age from a People Perspective', 'Gina Vargiu-Breuer', '2025-01-17', 11, e'Technological innovations such as artificial intelligence (AI) are reshaping entire industries and redefining the boundaries of what is possible. These advancements significantly boost productivity and help us reach new heights as societies.
...
This piece originally appeared on the World Economic Forum website .', '2026-06-16 13:41:29.430802', '2026-06-16 13:41:29.430802');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (149, 'https://news.sap.com/2024/12/values-adaptability-resilience-changing-world/', 'Navigating a Changing World: Why Values, Adaptability, and Resilience Matter More Than Ever', 'Thomas Saueressig', '2024-12-17', 11, e'In today’s rapidly changing world, it is increasingly clear that values matter. As we confront pressing issues such as social justice, climate change, and the weakening of democratic principles, it becomes essential to embrace core values like diversity, integrity, equality, and adaptability — not merely as ideals, but as necessities for progress.
...
Thomas Saueressig is a member of the Executive Board of SAP SE, leading Customer Services & Delivery.', '2026-06-16 13:41:29.430802', '2026-06-16 13:41:29.430802');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (150, 'https://news.sap.com/2024/11/human-expertise-age-of-ai-business-transformation-sap/', 'Harnessing Human Expertise in the Age of AI: Driving Business Transformations with SAP', 'Thomas Pfiester', '2024-11-06', 12, e'In the coming decades, humanity will achieve feats that would have seemed like magic to our grandparents. The rapid acceleration of progress, fueled by artificial intelligence (AI) and cloud technologies, is enabling us to solve problems once thought impossible. Some leaders are even calling this new era the intelligent age .
...
Our early customer successes show the power and the potential of SAP’s intelligent transformation approach. By combining human expertise with advanced AI and cloud technologies, SAP is setting a new standard for what is possible through business transformations. As we look to the future, this integrated approach will continue to enable businesses to unlock new value and drive sustainable success. At SAP, our vision is to redefine the way businesses transform, setting a benchmark for intelligent and integrated business transformations that drive real, measurable results. And for those organizations that adopt it, the possibilities in this new age are limitless.

Thomas Saueressig is a member of the Executive Board of SAP SE, leading Customer Services & Delivery. Thomas Pfiester is executive vice president and head of Global Customer Engagement & Services at SAP.', '2026-06-16 13:41:35.732862', '2026-06-16 13:41:35.732862');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (151, 'https://news.sap.com/2024/09/unlock-value-business-transformation-journey/', 'Unlock Value Throughout Your Business Transformation Journey', 'Thomas Saueressig', '2024-09-05', 12, e'Having worked with countless CIOs and C-suite executives embarking on large-scale business transformation, I’ve seen what goes into making digital transformation successful.
...
Thomas Saueressig is a member of the Executive Board of SAP SE leading Customer Services & Delivery.', '2026-06-16 13:41:35.732862', '2026-06-16 13:41:35.732862');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (152, 'https://news.sap.com/2024/06/elevating-rise-with-sap-experience/', 'Elevating the RISE with SAP Experience', 'Thomas Saueressig', '2024-06-17', 12, e'According to Albert Einstein, “Life is like a bicycle. To keep your balance, you must keep moving.” He had a point! The same is true of business.
...
Thomas Saueressig is a member of the Executive Board of SAP SE leading Customer Services & Delivery.', '2026-06-16 13:41:35.732862', '2026-06-16 13:41:35.732862');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (153, 'https://news.sap.com/2024/04/cloud-transformation-adoption-revolution-expectations-outcomes-meet/', 'SAP’s Adoption Revolution: When Expectations and Outcomes for Cloud Transformation Meet', 'Thomas Saueressig', '2024-04-02', 13, e'When an organization starts its digital transformation journey, it does so expecting great outcomes. Whether that means increasing competitiveness, efficiency, innovation, growth, employee satisfaction, reducing costs, or all of the above — expectations are always high.
...
Thomas Saueressig is a member of the Executive Board of SAP SE, leading Customer Services & Delivery.', '2026-06-16 13:41:40.275580', '2026-06-16 13:41:40.275580');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (154, 'https://news.sap.com/2024/01/trustworthy-ai-can-reinvent-companies-and-help-resolve-global-challenges/', 'Trustworthy AI Can Reinvent Companies and Help Resolve Global Challenges', 'Christian Klein', '2024-01-16', 13, e'“Vague but exciting.” The words were the understatement of the 20th century, scribbled on the margins of Tim Berners-Lee’s famous 1989 paper in which he effectively invented the World Wide Web. In hindsight, we know this was a revolutionary moment, which made the internet accessible to billions of people worldwide and ushered in an era of rapid digitalization.
...
This piece originally appeared on the World Economic Forum site .', '2026-06-16 13:41:40.275580', '2026-06-16 13:41:40.275580');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (155, 'https://news.sap.com/2024/01/is-supply-chain-innovation-possible-era-tighter-regulation/', 'Is Supply Chain Innovation Even Possible in an Era of Tighter Regulation?', 'Anahita Thoms', '2024-01-16', 13, e'The world is experiencing a new, tougher business environment. Trade tensions, wars, climate change, and countless other disruptions are putting the brakes on a long and steady period of globalization. Given this growing uncertainty, companies must reconfigure global supply chains to improve their resilience.
...
Thomas Saueressig is a member of the Executive Board of SAP SE. Anahita Thoms is partner and global lead sustainability partner for Industrials, Manufacturing, and Transportation at Baker McKenzie.', '2026-06-16 13:41:40.275580', '2026-06-16 13:41:40.275580');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (156, 'https://news.sap.com/2024/01/ai-act-dont-hesitate/', 'AI: Act, Don’t Hesitate', 'Thomas Saueressig', '2024-01-15', 14, e'Artificial intelligence (AI) is here, whether we like it or not . In my opinion, the rapid rise of generative AI can be attributed to three factors:
...
Innovation starts in the mind. Every company wants employees who think like entrepreneurs. Those who don’t want to wait for something coming from other corners of the world. But for that, we need to overcome our reservations towards new technologies. Fears are blocking our view of opportunities and companies have a duty to act now. Transparency is the most important means to alleviate employees’ concerns about automation and AI. AI will not make humans redundant, but it will change our existing professions. Well-trained professionals are and will remain indispensable, and AI can help to counteract the shortage of skilled workers to some extent. Not only the technologies themselves, but above all the responsible handling of data must be an integral part of school education. Similarly, companies should integrate AI into their company’s further education.

But what is particularly important is that for most professionals, it is not about understanding AI in every detail. There are experts for that, just as there are experts who design complex manufacturing machines. It is about developing the skills of the future: critical thinking and the ability to assess information and above all, empathy. Putting oneself in other people’s position is the core competency of the future! These are skills that make humans unique. Therefore, I do not see AI as an apocalypse, but rather as one of our best chances for renewal and progress. Because the interaction between humans and machines is not a duel, but a duet.

Thomas Saueressig is a member of the Executive Board of SAP SE.', '2026-06-16 13:41:47.630852', '2026-06-16 13:41:47.630852');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (157, 'https://news.sap.com/2023/12/being-human-in-the-age-of-ai/', 'Being Human in the Age of AI', 'Thomas Saueressig', '2023-12-20', 14, e'For thousands of years humans have tried to predict, manage, and control the future. Our ancestors looked for advice from oracles and read the stars. In more recent history, we have turned to science to determine future trends. But a fixed and knowable future doesn’t exist.
...
Generative AI is disrupting every industry, just like the internet did back in the 1990s. Both disruptions have something in common: people are at the center. The internet took off because it was easy for non-technical users to adopt it. This is exactly what’s happening now with AI.
...
Top photo courtesy of SAP employee Emanuela Corazziari.', '2026-06-16 13:41:47.630852', '2026-06-16 13:41:47.630852');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (158, 'https://news.sap.com/2023/11/supply-chain-issues-keeping-ceos-up-at-night/', 'Supply Chain Issues Keeping CEOs Up at Night', 'Thomas Saueressig', '2023-11-13', 14, e'Building risk-resilient supply chains is one of the top issues CEOs are discussing on earning calls and in board rooms around the globe. The issue has gone from one priority among many to business critical. And CEOs are no longer just pursuing lower costs, shorter lead times, and higher quality.
...
Thomas Saueressig is a member of the Executive Board of SAP SE, SAP Product Engineering.', '2026-06-16 13:41:47.630852', '2026-06-16 13:41:47.630852');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (159, 'https://news.sap.com/2023/09/sap-business-ai-joule/', 'Pioneering the Business AI Revolution', 'Thomas Saueressig', '2023-09-27', 15, e'“The only constant is change.” This has always been true for enterprise software. And agility, especially when it comes to the ability of software architecture to create and respond to change, is at the heart of reinventing business processes.
...
Thomas Saueressig is a member of the Executive Board of SAP SE.', '2026-06-16 13:41:53.802178', '2026-06-16 13:41:53.802178');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (160, 'https://news.sap.com/2023/03/grow-with-sap-cloud-erp-offering-midsize-companies/', 'SAP Launches Cloud ERP Offering for Midsize Companies', 'Christian Klein', '2023-03-21', 15, e'Midsize companies are the growth engines of the future. But while they incubate the innovations and novel ideas that will change our world, they also struggle with many of the same business pressures as their larger counterparts. Midmarket leaders need flexible, agile tools to effectively manage their businesses and take them to the next level in an ever-changing, fiercely competitive, and often unpredictable market.
...
Christian Klein is CEO and a member of the Executive Board of SAP SE.', '2026-06-16 13:41:53.802178', '2026-06-16 13:41:53.802178');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (161, 'https://news.sap.com/2023/01/fragmented-world-technology-unites/', 'In a Fragmented World, Technology Brings Us Together', 'Christian Klein', '2023-01-31', 15, e'Today’s world is characterized by economic and non-economic disruptions that are deeply intertwined: volatile markets, inflation, geopolitical tensions and war, the energy crisis, and climate change. No one business, government, or society can tackle challenges on this scale alone.
...
Christian Klein is CEO of SAP SE. This story originally appeared on the World Economic Forum website .', '2026-06-16 13:41:53.802178', '2026-06-16 13:41:53.802178');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (162, 'https://news.sap.com/2022/12/eight-2023-industry-trends-here-to-stay/', 'Eight Industry Trends That Are Here to Stay', 'Thomas Saueressig', '2022-12-13', 16, e'The end of the year is a good time to think about what lies ahead of us. I believe there are some business, technical, and social developments that will affect organizations across industries.
...
This blog originally appeared on SAP BrandVoice on Forbes .', '2026-06-16 13:42:00.212042', '2026-06-16 13:42:00.212042');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (163, 'https://news.sap.com/2022/09/changing-work-for-good/', 'Changing Work for Good', 'Thomas Saueressig', '2022-09-13', 16, e'The tide has turned on the job market. Over the past few years, organizations had to turn from one crisis to the next. Climate change, the pandemic, macroeconomic forces, and the skills gap have implications for our planet, global supply chains, and the energy and financial markets. This keeps leaders up at night and affects the people in their teams alike.
...
Thomas Saueressig is a member of the Executive Board of SAP SE.', '2026-06-16 13:42:00.212042', '2026-06-16 13:42:00.212042');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (164, 'https://news.sap.com/2022/06/circular-economy-sap-customers-reduce-food-waste/', 'Together Toward a Circular Economy', 'Thomas Saueressig', '2022-06-29', 16, e'“ Hunger levels are at a new high ,” according to United Nations Secretary-General António Guterres. In just the past two years, the number of severely food insecure people worldwide has doubled. Yet, he added, “there is enough food in our world now for everyone, if we act together.”
...
Thomas Saueressig is a member of the Executive Board of SAP SE, SAP Product Engineering.', '2026-06-16 13:42:00.212042', '2026-06-16 13:42:00.212042');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (165, 'https://news.sap.com/2022/05/sustainability-road-map-security-stability-progress/', 'Sustainability Is Our Road Map to Security, Stability, and Progress', 'Christian Klein', '2022-05-23', 17, e'Coming on the heels of a global pandemic that changed the way we live and work, the war in Ukraine has deepened the uncertainty and instability we face. If any good is to come from these disruptions, it is that organizations have been given the opportunity to reinvent themselves for the better. They can reimagine how they innovate, operate, and create value for all stakeholders by leaving behind practices of the past and embracing the vision of sustainability for the future.
...
Christian Klein is CEO of SAP SE.', '2026-06-16 13:42:06.603652', '2026-06-16 13:42:06.603652');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (166, 'https://news.sap.com/2022/05/exceptions-norm-business-resilience-objective/', 'When Exceptions Become the Norm, Resilience Becomes the Objective', 'Thomas Saueressig', '2022-05-18', 17, e'In 1969, The New York Times Magazine captured the U.S. National Security Advisor Henry Kissinger’s comment, “ There can’t be a crisis next week. My schedule is already full. ” The ironic quip underscored the need to meet a crisis with agility. And nothing is more salient today, in our crisis-plagued world, than the wish for solutions to deal with crises.
...
Thomas Saueressig is a member of the Executive Board of SAP SE, leading SAP Product Engineering.', '2026-06-16 13:42:06.603652', '2026-06-16 13:42:06.603652');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (167, 'https://news.sap.com/2022/03/standing-in-solidarity/', 'Standing in Solidarity', 'Christian Klein', '2022-03-02', 17, e'Like the rest of the world, we are watching the war in Ukraine with horror and condemn the invasion in the strongest possible terms. An act as inhumane and unjustified as this is an attack on democracy and humanity. Its consequences affect us all.

Economic sanctions are an important mechanism in the efforts to restore peace. We are in constant exchange with governments around the world, have every confidence in their guidance, and fully support the actions taken so far. We are stopping business in Russia and Belarus aligned with sanctions and, in addition, pausing all sales of SAP services and products in Russia and Belarus.
...
Christian Klein is CEO of SAP SE.', '2026-06-16 13:42:06.603652', '2026-06-16 13:42:06.603652');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (168, 'https://news.sap.com/2022/01/moving-toward-sustainable-world/', 'Changing Our Reality for the Better by Moving Toward a Sustainable World', 'Thomas Saueressig', '2022-01-14', 18, e'Gone are the days when companies discussed the why of sustainable business practices. Today, it is all about the how .
...
Thomas Saueressig is a member of the Executive Board of SAP SE leading SAP Product Engineering.', '2026-06-16 13:42:12.953400', '2026-06-16 13:42:12.953400');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (169, 'https://news.sap.com/2021/12/planet-cannot-afford-fragmented-reporting-sap-sustainability-control-tower/', 'Our Planet Cannot Afford Fragmented Reporting – Can You?', 'Thomas Saueressig', '2021-12-14', 18, e'There is consensus. The recent United Nations Climate Change Conference of the Parties ( COP26 ) made at least two things clear: we need to move faster toward our goal to reduce greenhouse gas emissions and a fair transition won’t come cheap. Therefore, no enterprise can afford to waste time or money when it comes to aligning their sustainability ambitions with their actions.
...
Christian Klein is CEO of SAP SE.', '2026-06-16 13:42:12.953400', '2026-06-16 13:42:12.953400');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (171, 'https://news.sap.com/2021/09/building-solutions-future-arrived/', 'Building Solutions for a Future That Has Already Arrived', 'Thomas Saueressig', '2021-09-16', 19, e'The time for climate action is now. Many are talking about it. We are acting. This is humanity’s chance to recalibrate and respond to the dire threats we ourselves created. We are continuing to deeply embed sustainability into the enterprise software this world needs now more than ever. With the help of our solution portfolio, SAP – together with our unparalleled customer and partner base – is best positioned to systematically reduce carbon emissions and help business tackle today’s most complex challenges.

“The world is on fire,” according to satellite images captured by NASA and a recent Business Insider interview with astronauts from the International Space Station. While many parts of the world deal with extreme heat, others struggle with extreme flooding. The recent United Nation (UN) Intergovernmental Panel on Climate Change (IPCC) climate report says nations are “nowhere close” to the level of action needed to fight global warming and the effects of extreme weather caused by climate change. The need for climate action is undeniable and opportunities for green house gas (GHG) reductions are within our grasp. Action to date has been slow, but it’s accelerating.

I see a surge in companies seeking to reduce GHG emissions coming. November’s upcoming COP26 , the 26th UN Climate Change Conference of the Parties, is set to ensure that action around science-based target setting will accelerate. And I’m hearing from industry and government leaders that we will see unprecedented corporate climate action, driven by regulation and good business, that aligns with the 1.5 degree of global warming limit set by the Paris Agreement .
...
While every company can start by focusing on their own individual supply chains, those further down the path to sustainability can use the network as a pathway to scale . According to IDC *, “Consolidating data into a unified network means better access, streamlined analysis and the opportunity to more effectively turn insights into action.” Systemic industry change needs the network effect, and it needs a spark.
...
We emphasize the role of technology for the green transition and EU taxonomy as a founding member of European Green Digital Coalition . In addition to working with these established partners and others, SAP is supporting sustainability innovation from startups around the world. For example, through our SAP.iO Foundries program, startups play a pivotal role in catalyzing innovations on sustainability across the globe.

We facilitated systemic industry change 50 years ago with our enterprise software based on our founders’ vision. Now we are doing it again in order to tackle the climate crisis. The business model innovation we drive helps improve energy efficiency across both conventional and renewable energy value chains, it supports decarbonizing through electricity generation and transmission such as green hydrogen, and it helps our customers to decarbonize their products and services, for example, by adopting circularity.
...
*IDC InfoBrief, Sponsored by SAP, Global B2B Collaboration Networks: Critical Enablers of Business Resiliency, IDC Doc. #US47857121, August 2021.', '2026-06-16 13:42:19.040284', '2026-06-16 13:42:19.040284');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (172, 'https://news.sap.com/2021/09/solution-order-management-transform-products-services-offered-sold/', 'Transforming How Products and Services Are Offered and Sold', 'Thomas Saueressig', '2021-09-02', 19, e'Today, we see an increasing shift to “servitization” or “everything-as-a-service” business models, which includes new digital business models such as streaming. This changes not only how products and services are consumed, but also how and when they are ordered and paid for.
...
Thomas Saueressig is a member of the Executive Board of SAP SE. This story was originally published on LinkedIn .', '2026-06-16 13:42:19.040284', '2026-06-16 13:42:19.040284');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (173, 'https://news.sap.com/2021/08/value-networks-sustainable-business/', 'When Value Chains Become Value Networks, Business Becomes Sustainable', 'Thomas Saueressig', '2021-08-05', 19, e'Whether a business is listed on the New York Stock Exchange or has only a single storefront located on the corner of a busy street, both have at least one thing in common: digitalization has never been more urgent.
...
Thomas Saueressig is a member of the Executive Board of SAP SE leading SAP Product Engineering. This article originally appeared on LinkedIn .', '2026-06-16 13:42:19.040284', '2026-06-16 13:42:19.040284');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (174, 'https://news.sap.com/2021/07/earth-overshoot-day-business-as-usual-can-cost-us-dearly/', 'Why Doing Business As Usual Can Cost Us Dearly', 'Christian Klein', '2021-07-29', 20, e'I am a proud dad of two young kids. Since they were born, the world has experienced a global pandemic , increasing social unrest, numerous political conflicts, and countless natural disasters from heat waves and wildfires to record flooding.
...
Christian Klein is CEO of SAP SE. This piece was originally published on LinkedIn .', '2026-06-16 13:42:24.989318', '2026-06-16 13:42:24.989318');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (175, 'https://news.sap.com/2021/07/sap-intelligent-returns-management-consumers-retailers-environment/', 'Helping Consumers, Retailers, and the Environment', 'Thomas Saueressig', '2021-07-02', 20, e'Our customers face new market conditions, competition and challenges every day, so they rely on us to deliver the technology and solutions to help them survive and thrive in this dynamic and increasingly digital environment. SAP’s deep industry domain knowledge has enabled us to deliver the best and most innovative business process support for our customers for almost 50 years.
...
Thomas Saueressig is a member of the Executive Board of SAP SE for SAP Product Engineering. This story was originally published on LinkedIn .', '2026-06-16 13:42:24.989318', '2026-06-16 13:42:24.989318');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (176, 'https://news.sap.com/2021/06/beyond-four-walls-business-product-innovation-sapphire-now/', 'Going Beyond the Four Walls of Your Business', 'Thomas Saueressig', '2021-06-08', 20, e'Beyond the headline-grabbing news about a pandemic, trade barriers, and accelerated online purchasing, many forces are increasing pressure on supply chains. Over the past year, I’ve had many conversations with business leaders about their supply chain challenges.
...
Thomas Saueressig is a member of the Executive Board of SAP SE, Product Engineering. This story was originally published on LinkedIn .', '2026-06-16 13:42:24.989318', '2026-06-16 13:42:24.989318');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (117, 'https://news.sap.com/2026/05/the-next-era-of-business-ai/', 'The Next Era of Business AI', 'Christian Klein', '2026-05-26', 1, e'Today, most companies are experimenting with AI. Many of them can point to demos that impressed, pilots that worked, and tools that saved time in narrow tasks. Far fewer can say AI has changed their business across functions, processes, and teams.
...
Christian Klein is CEO of SAP SE.', '2026-06-16 13:40:26.090107', '2026-06-16 13:40:26.090107');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (118, 'https://news.sap.com/2026/05/ai-race-being-fought-in-wrong-place/', 'The AI Race Is Being Fought in the Wrong Place', 'Christian Klein', '2026-05-19', 1, e'The enterprise AI race is quickly becoming a contest over interfaces.
...
This article originally appeared on Fortune.com .', '2026-06-16 13:40:26.090107', '2026-06-16 13:40:26.090107');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (119, 'https://news.sap.com/2026/05/new-joule-studio-enterprise-scale-agentic-development/', 'Announcing New Joule Studio for Enterprise Scale Agentic Development', 'Michael Ameling', '2026-05-13', 1, e'SAP has held a long-standing mission to help organizations turn ideas into innovation faster, continually evolving our technology to give developers and business users the tools they need to build what’s next.
...
Michael Ameling is president of SAP Business Technology Platform and a member of the Extended Board of SAP SE.', '2026-06-16 13:40:26.090107', '2026-06-16 13:40:26.090107');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (120, 'https://news.sap.com/2026/05/sap-anthropic-to-bring-claude-sap-business-ai-platform/', 'SAP and Anthropic Plan to Bring Claude to SAP Business AI Platform', 'Philipp Herzig', '2026-05-12', 2, e'Enterprises don’t need to be rebuilt around AI. AI needs to be thoughtfully brought into the enterprise—in a way that respects what is already working and strengthens it.
...
Philipp Herzig is CTO and a member of the Extended Board of SAP SE.', '2026-06-16 13:40:32.024147', '2026-06-16 13:40:32.024147');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (121, 'https://news.sap.com/2026/05/sap-palantir-enhance-partnership-ai-supported-data-migration-tooling/', 'SAP and Palantir Enhance Partnership with AI-Supported Data Migration Tooling to Accelerate Enterprise Cloud ERP Transformation for Autonomous Enterprises', 'Jan Gilg', '2026-05-12', 2, e'Partnership opens new pathways for enterprise data migration with SAP AI-supported tooling complemented by Palantir’s AIP for data migration scenarios to simplify an expedite digital transformation for SAP customers, with Accenture as a co-innovation partner for joint customers
...
Jan Gilg is a member of the Extended Board of SAP SE.', '2026-06-16 13:40:32.024147', '2026-06-16 13:40:32.024147');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (122, 'https://news.sap.com/2026/04/five-make-or-break-moments-2026-ai-ambitions/', 'Five Make-or-Break Moments for Your AI Ambitions in 2026', 'Manos Raptopoulos', '2026-04-30', 2, e'Let me start with a simple experiment: Ask a generative AI tool to count the words in a document. It will likely be off by 10%.
...
Manos Raptopoulos is global president of Customer Success Europe, APAC, Middle East & Africa, and a member of the Extended Board SAP SE.', '2026-06-16 13:40:32.024147', '2026-06-16 13:40:32.024147');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (123, 'https://news.sap.com/2026/04/engagement-divide-15-reasons-to-fix-customer-experience/', 'The Engagement Divide: 15 Reasons It’s Time to Fix CX', 'Manos Raptopoulos', '2026-04-21', 3, e'Customer engagement is at a breaking point, and the most recent data proves it. Even as organizations accelerate their investment in AI, automation, and analytics, experiences often feel disconnected, impersonal, and reactive.
...
Manos Raptopoulos is global president of Customer Success Europe, APAC, Middle East & Africa, and a member of the Extended Board SAP SE.', '2026-06-16 13:40:38.079072', '2026-06-16 13:40:38.079072');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (124, 'https://news.sap.com/2026/04/honoring-2026-sap-innovation-award-winners/', 'From Readiness to Resilience: Honoring the 2026 SAP Innovation Award Winners', 'Thomas Saueressig', '2026-04-14', 3, e'Across industries and geographies, organizations are operating in an environment defined by uncertainty. Geopolitical volatility, supply chain disruption, regulatory complexity, and accelerating technological change are no longer exceptional circumstances. They are the new baseline.
...
Thomas Saueressig is Chief Customer Officer and Member of the Executive Board of SAP SE.', '2026-06-16 13:40:38.079072', '2026-06-16 13:40:38.079072');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (125, 'https://news.sap.com/2026/03/orchestrating-continuous-transformation-stronger-business-outcomes/', 'Orchestrating Continuous Transformation for Stronger Business Outcomes', 'Thomas Pfiester', '2026-03-03', 3, e'Business transformation is no longer only defined by milestones. It is shaped by continuous progress and by the ability to move the promise of innovation from boardroom imperatives into daily results.
...
Thomas Pfiester is head of Customer Engagement and Adoption and a member of the Extended Board of SAP SE.', '2026-06-16 13:40:38.079072', '2026-06-16 13:40:38.079072');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (126, 'https://news.sap.com/2026/01/sap-at-davos-why-ai-without-humanity-is-incomplete/', 'Why AI Without Humanity Is Incomplete', 'Gina Vargiu-Breuer', '2026-01-19', 4, e'Artificial intelligence (AI) has moved far beyond experimentation. It is already reshaping how industries operate, how economies evolve, and how people experience work.
...
This piece originally appeared on the World Economic Forum website .', '2026-06-16 13:40:44.697639', '2026-06-16 13:40:44.697639');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (127, 'https://news.sap.com/2026/01/sap-at-davos-growth-paradoxes-intelligent-age/', 'Unlocking Growth by Embracing the Paradoxes of the Intelligent Age', 'Christian Klein', '2026-01-16', 4, e'The Intelligent Age is marked by rapid technological progress, societal shifts and complex paradoxes. We’re more connected yet more isolated; flooded with information but uncertain of truth; empowered and threatened by technology.
...
This piece originally appeared on the World Economic Forum website .', '2026-06-16 13:40:44.697639', '2026-06-16 13:40:44.697639');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (128, 'https://news.sap.com/2026/01/sap-business-ai-release-highlights-q4-2025/', 'SAP Business AI: Release Highlights Q4 2025', 'Philipp Herzig', '2026-01-14', 4, e'We want our customers to get value from AI. So when organizations cite barriers to deriving value, such as integration complexity , regulatory compliance , AI sovereignty , or data quality , we work to alleviate them.
...
Joule with Microsoft 365 Copilot General availability
...
Joule Analytics Center General availability
...
Joule Preview Landscape General availability
...
Joule deep research capability Beta release
...
Performance Preparation Agent General availability
...
SAP SuccessFactors solutions, AI-assisted skill identification from resume General availability
...
SAP SuccessFactors Succession and Development, AI-assisted successor recommendation General availability
...
SAP SuccessFactors solutions, SAP Document AI, embedded edition General availability
...
Production Planning and Operations Agent Beta release
...
SAP Integrated Business Planning, AI-assisted supply optimization analysis General availability
...
For instance, planners can ask Joule questions such as, “What is the status of the optimization run for planning area XYZ?” “Which products are affected by unfulfilled demand?”, or “Tell me which locations have unfulfilled inventory targets.” As a result, planners achieve up to 25%* higher productivity in analyzing planning results, translating into quicker and more confident adjustments to the supply chain model and enhanced overall operational agility.

Get started here .

SAP Integrated Business Planning, AI-assisted analysis of inventory optimization results General availability
...
SAP Integration Business Planning, AI-assisted forecast results analysis General availability
...
SAP Integrated Product Development, AI-assisted text generation General availability
...
Joule with SAP Logistics Management SAP Early Adopter Care release
...
Accounting Accruals Agent Beta release
...
International Trade Classification Agent Beta release
...
Cash Management Agent for SAP S/4HANA Cloud Public Edition and SAP S/4HANA Cloud Private Edition Beta release
...
Change Record Management Agent Beta release
...
SAP S/4HANA Cloud Private Edition, AI-assisted depreciation key explanation General availability
...
SAP S/4HANA Cloud Private Edition, Joule for Developers, ABAP AI capabilities General availability
...
SAP Master Data Governance on SAP S/4HANA Cloud Private Edition, AI-assisted central governance General availability
...
SAP S/4HANA Cloud Public Edition, AI-assisted allocation run results General availability
...
SAP S/4HANA Cloud Public Edition, AI-assisted hands-free production order management General availability
...
Joule with SAP Risk and Assurance Management General availability
...
Booking Agent General availability
...
Receipt Analysis Agent SAP Early Adopter Care release
...
SAP Ariba Intake Management, AI-assisted demand intake General availability
...
SAP Emarsys Customer Engagement, AI-assisted report builder General availability
...
SAP Service Cloud Version 2, AI-assisted premise billed consumption summary General availability
...
Joule studio, agent builder General availability
...
Generative AI Hub in AI Foundation, enhancements General availability
...
SAP Document AI, enhancements General availability
...
SAP Cloud ALM, AI-assisted requirement generation General availability
...
SAP Micro-App Hub, AI-assisted user learning, and change management Early Adopter Care program
...
Utilities Customer Self-Service Agent General availability
...
Tender Analysis Agent General availability
...
SAP Sports One, AI-assisted scouting General availability
...
SAP Information Collaboration Hub for Life Sciences, AI-assisted error analysis General availability
...
SAP Batch Release Hub for Life Sciences, AI-assisted batch release processing SAP Early Adopter Care program
...
Dashboard Analyzer Agent for SAP Signavio Beta release
...
Screen Guide Agent for SAP Signavio Beta release
...
Workspace Administration Agent for SAP Signavio Beta release
...
Value Case Creation Agent for SAP Signavio Beta release
...
Process Content Recommender Agent for SAP Signavio Beta release
...
SAP Signavio Process Transformation Manager, AI-assisted insights description generator General availability
...
SAP Signavio solutions, AI-assisted transformation advisory, initiative builder General availability
...
SAP LeanIX, AI Agent Hub General availability
...
WalkMe, SAP Joule Action Bar SAP Early Adopter Care release
...
Philipp Herzig is CTO of SAP SE.

*Disclaimer: This article provides estimated benefits. All calculations are estimates based on SAP customer case studies, SAP benchmarks, and other research. Actual benefits may vary and may be affected by additional factors not considered by this article. The information is provided “as is” without warranty of any kind, expressor implied, and in no event shall SAP be liable for any damages whatsoever in relation with the use of this article. See Legal Notice on https://www.sap.com/legal-notice for use terms, disclaimers, disclosures, or restrictions related to this material.', '2026-06-16 13:40:44.697639', '2026-06-16 13:40:44.697639');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (129, 'https://news.sap.com/2026/01/beyond-tech-expanding-perspectives-sap-the-ocean-cleanup/', 'The Digital Ocean: In Conversation with the Biggest Cleanup Project in Human History', 'Manos Raptopoulos', '2026-01-13', 5, e'In a world where technology moves at lightning speed, I am fortunate to have a vantage point and a unique opportunity to see the connections business leaders make and the possibilities they create in defining moments for their industry.
...
Manos Raptopoulos is global president of Customer Success, Europe, APAC, Middle East & Africa, and a member of the Extended Board at SAP.', '2026-06-16 13:40:49.878028', '2026-06-16 13:40:49.878028');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (130, 'https://news.sap.com/2025/11/business-ai-innovation-unveiled-at-sap-teched/', 'Business AI Innovation Unveiled at SAP TechEd', 'Philipp Herzig', '2025-11-17', 5, e'We’ve made phenomenal progress embedding AI across the suite. By the end of 2025, we will have 400 SAP Business AI use cases delivered in our solutions, including 40 Joule Agents, building on 2,100 Joule Skills. Our existing more than 300 use cases translate into 441 million EUR value add for a company with 10 billion EUR annual revenue.
...
Philipp Herzig is CTO of SAP.', '2026-06-16 13:40:49.878028', '2026-06-16 13:40:49.878028');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (131, 'https://news.sap.com/2025/11/new-agentic-capabilities-sap-btp-supercharge-developers/', 'New Agentic Capabilities on SAP BTP Supercharge Developers for What’s Next', 'Michael Ameling', '2025-11-05', 5, e'This week at SAP TechEd Berlin , we released new innovations that deliver on our promise to make SAP more open and empower developers to move faster and smarter with the tools, languages, and frameworks of their choice.
...
MCP Gateway support will enable customers to expose custom APIs and integration flows that can be consumed by AI agents. This feature introduces the ability for customers to enrich custom agents built in Joule Studio or extend Joule Agents by integrating data from third-party and legacy SAP systems, composed as MCP tools for smooth agentic consumption. This approach standardizes access, centralizes governance and security, and simplifies discoverability in the developer hub .
...
Michael Ameling is general manager and chief product officer of Business Technology Platform and a member of the Extended Board of SAP SE.', '2026-06-16 13:40:49.878028', '2026-06-16 13:40:49.878028');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (132, 'https://news.sap.com/2025/10/sap-business-ai-release-highlights-q3-2025/', 'SAP Business AI: Release Highlights Q3 2025', 'Philipp Herzig', '2025-10-22', 6, e'Recently, at SAP Connect , we highlighted an incredible array of new Joule Agents embedded in key business processes and across every line of business.
...
Shop Floor Supervisor Agent Beta release
...
Joule with SAP S/4HANA Cloud Public Edition Product enhancements General availability
...
Booking Agent SAP Early Adopter Care release
...
Catalog Optimization Agent Beta release
...
Digital Service Agent General availability
...
Generative AI Hub Product enhancements General availability
...
SAP Joule for Developers, ABAP AI capabilities Product enhancements General availability
...
SAP Build solutions AI-assisted content creation and summary General availability
...
Joule studio Agent builder Beta release
...
SAP Signavio solutions AI-assisted context analyzer, text-to-event matching Beta release
...
SAP Signavio solutions AI-assisted context analyzer, sentiment analysis Beta release
...
SAP Signavio Collaboration Hub AI-assisted role-based process overview Beta release
...
SAP S/4HANA Cloud Public Edition, EHS environment management AI-assisted permit management Beta release
...
SAP Green Ledger AI-assisted carbon emission analysis SAP Early Adopter Care release
...
SAP S/4HANA Cloud Public Edition, workplace safety AI-assisted safety observation reporting Beta release
...
*Disclaimer: This article provides estimated benefits. All calculations are estimates based on SAP customer case studies, SAP benchmarks, and other research. Actual benefits may vary and may be affected by additional factors not considered by this article. The information is provided “as is” without warranty of any kind, expressor implied, and in no event shall SAP be liable for any damages whatsoever in relation with the use of this article. See Legal Notice on https://www.sap.com/legal-notice for use terms, disclaimers, disclosures, or restrictions related to this material.', '2026-06-16 13:40:55.380915', '2026-06-16 13:40:55.380915');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (133, 'https://news.sap.com/2025/10/ai-growth-engine-leaders-bet-on/', 'AI Is the Growth Engine Leaders Are Betting On', 'Manos Raptopoulos', '2025-10-14', 6, e'Growth, simplification, and artificial intelligence (AI) are no longer optional. That is the unmistakable signal from SAP’s Global Business Priorities Study, which surveyed nearly 12,000 executives across 20 markets and 31 industries. The results capture both urgency and possibility.
...
Manos Raptopoulos is chief revenue officer of APAC, EMEA, and MEE, and a member of the Extended Board of SAP SE.', '2026-06-16 13:40:55.380915', '2026-06-16 13:40:55.380915');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (134, 'https://news.sap.com/2025/08/partners-free-sap-build-licenses-tdd-ai-powered-intelligent-applications/', 'Empowering Partners with Free SAP Build Licenses for Test, Demo, and Development to Create AI-Powered and Intelligent Applications', 'Karl Fahrbach', '2025-08-11', 6, e'SAP partners enrich our industry-leading portfolio with unique IP built on SAP Business Technology Platform (SAP BTP), the platform that unlocks partners’ ability to innovate, extend, and integrate business applications at scale.
...
Michael Ameling is president of SAP Business Technology Platform and a member of the Extended Board of SAP SE. Karl Fahrbach is chief partner officer of SAP.', '2026-06-16 13:40:55.380915', '2026-06-16 13:40:55.380915');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (135, 'https://news.sap.com/2025/07/q2-2025-sap-customers-momentum-americas/', 'Q2 2025: SAP’s Customer Momentum in the Americas', 'Jan Gilg', '2025-07-25', 7, e'In the second quarter of 2025 , SAP demonstrated significant momentum in the Americas. Organizations across the region and industries are continually recognizing SAP as a premier partner for driving transformation and strategic initiatives.
...
Jan Gilg is CRO, president of SAP Americas & Global Business Suite, and a member of the Extended Board of SAP SE.', '2026-06-16 13:41:02.273614', '2026-06-16 13:41:02.273614');
INSERT INTO public.sap_news_blog (id, url, title, author, published_at, page_number, content, created_at, updated_at) VALUES (136, 'https://news.sap.com/2025/07/sap-business-ai-release-highlights-q2-2025/', 'SAP Business AI: Release Highlights Q2 2025', 'Philipp Herzig', '2025-07-24', 7, e'Customers are at the center of everything we do with SAP Business AI . Our innovations and partnerships announced at SAP Sapphire and additional releases in the second quarter of 2025 reaffirm this focus.
...
SAP Joule for Consultants Generally available
...
Joule in Microsoft 365 Copilot and Microsoft Teams Generally available
...
Analytical insights feature Generally available
...
Joule with SAP Digital Manufacturing Generally available
...
SAP Digital Manufacturing, AI-assisted production engineering Beta release
...
SAP Integrated Business Planning, add-in for Microsoft Excel, AI-assisted planning SAP Early Adopter Care release
...
Field Service Dispatcher Agent Beta release
...
Maintenance Planner Agent Beta release
...
SAP Document and Reporting Compliance, AI-assisted electronic document error handling Generally available
...
Joule with SAP S/4HANA Cloud Public Edition product enhancements Generally available
...
Joule with SAP S/4HANA Cloud Private Edition product enhancements Generally available
...
Accounts Receivable Agent Beta release
...
Meeting Location Planner Agent Beta release
...
Expense Report Validation Agent SAP Early Adopter Care release
...
SAP SuccessFactors solutions, AI-assisted bulk translation Generally available
...
SAP SuccessFactors Learning, AI-assisted image generation for learning Generally available
...
SAP SuccessFactors Performance & Goals, AI-assisted sentiment analysis in 360 reviews Generally available
...
SAP SuccessFactors Performance & Goals , AI-assisted performance insights Generally available
...
SAP SuccessFactors Succession & Development , AI-assisted successor insights Generally available
...
SAP SuccessFactors Recruiting, AI-assisted interview feedback insights Generally available
...
SAP SuccessFactors solutions, AI-assisted extended AI locales Generally available
...
Joule with SAP SuccessFactors Mobile Generally available
...
SAP SuccessFactors Employee Central, AI-assisted explain pay Generally available
...
Performance and Goals Agent Beta release
...
SAP Service Cloud Version 2, AI-assisted entity extraction ​ Generally available
...
SAP Service Cloud Version 2, AI-assisted registered product summary Generally available
...
SAP Sales Cloud Version 2, AI-assisted sales order summary Generally available
...
SAP CX AI Toolkit Shopping Agent Generally available
...
SAP CX AI Toolkit Custom AI agents Generally available
...
Joule with SAP Enterprise Service Management and SAP Service Cloud Version 2 SAP Early Adopter Care release
...
Register for the SAP Early Adopter Care program for SAP Enterprise Service Management and the SAP Ea r ly Adopter Care program for SAP Service Cloud Version 2 .

SAP Emarsys , AI-assisted product finder Beta release
...
Joule with SAP Fieldglass solutions Generally available
...
SAP Fieldglass Contingent Workforce Management , AI-assisted skill-based job posting Generally available
...
SAP Ariba Category Management , AI-assisted strategy summarizer Generally available
...
Joule Studio in SAP Build Skill builder Generally available
...
Generative AI hub prompt optimizer Preview
...
Generative AI hub product enhancements Generally available
...
SAP Document AI product enhancements Generally available
...
SAP HANA Cloud p roduct enhancements Generally available
...
SAP Build Code SAP HANA Cloud text to SQL generation Generally available
...
SAP Build Code SAP HANA application migration assistant Generally available
...
Joule with SAP Business Accelerator Hub Generally available
...
Joule with SAP Datasphere SAP Early Adopter Care release
...
SAP Cell and Gene Therapy Orchestration, AI-assisted exception management Beta release
...
Philipp Herzig is CTO, chief AI officer, and a member of the Extended Board of SAP SE. Stefan Baeuerle is senior vice president and head of SAP BTP/SAP HANA & Persistency at SAP.', '2026-06-16 13:41:02.273614', '2026-06-16 13:41:02.273614');
